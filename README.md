...
This project implements both saga patterns (orchestration and choreography) with RabbitMQ. See [SAGA_README.md](SAGA_README.md) for details, examples, and comparison.
